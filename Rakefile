...
desc 'Generate documentation for the correios_shipping_calculator extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'CorreiosShippingCalculatorExtension'
...
desc 'Test the correios_shipping_calculator extension.'
